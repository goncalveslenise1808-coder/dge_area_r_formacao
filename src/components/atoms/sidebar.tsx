      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            side={"left"}
            className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden bg-background"
            style={
              {
          ...
          >
            <SheetHeader>
              <SheetTitle className="sr-only">Sidebar mobile</SheetTitle>
            </SheetHeader>
            <div className="flex h-full w-full flex-col relative">{children}</div>
          </SheetContent>
        </Sheet>
      )
    }
