                                ...
                                {safeSelected ? (
                                    <div className="flex flex-col gap-4">
                                        <div className='flex gap-4'>
                                            {!arquivada && (
                                                <Button
                                                    ...
                                                    className='bg-transparent text-black/60 border-b-2 border-black/10 hover:border-black/60 rounded-none dark:text-white'
                                                >
                                                    Arquivar
                                            ...
                                            <Button
                                                ...
                                                className='bg-transparent text-black/60 border-b-2 border-black/10 hover:border-red-400 hover:text-red-400 rounded-none dark:text-white'
                                            >
                                                Eliminar
                                        ...
                                        <div className="flex justify-end gap-2">
                                            <span
                                                className="font-light text-[10px]"> {formatarData(safeSelected?.dataEnvio, true)}</span>
                                        </div>
